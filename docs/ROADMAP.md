...
| **最終更新（md）** | 2026-07-29（Sprint S5: influence-map · poisson-disk · decision-tree · ready 110） |
...
**ready 合計: 110**（2026-07-29 · Sprint S5 後）。
...
| Sprint S5 | `influence-map` · `poisson-disk` · `decision-tree` | **実装済**（2026-07-29） |
| 以降候補 | goap-lite · theta-star · blackboard · … | 調査済・未着手（CANDIDATE 優先度 B） |
