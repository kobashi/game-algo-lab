...
| **成熟度** | 新規は通常 `oneshot`・修正 0・更新日（[MATURITY.md](../topics/MATURITY.md)） |
| 学習目標 | 3 つ以内 |
...
2. `js/platform/maturity.js` の `TOPIC_META`（`maturity` / `revisions` / `updated`）  
3. `docs/topics/CATALOG.md` に1行（成熟度・修正・更新・改訂メモ）  
4. 完成後 `ready: true`。初回は通常 **`maturity: "oneshot"`**・**revisions: 0**  
